...
class BallDetector:
    def __init__(self):
        ...
        rospy.Subscriber('/d400/color/image_raw', Image, self.image_callback) #camera to d400 for final
        rospy.Subscriber('/d400/aligned_depth_to_color/image_raw', Image, self.depth_callback) #camera to d400 for final
